...
class SSIDSuspendTool: NSObject {
    ...
    private func openLocationSettings() {
        ...
        NSAlert.alert(with: NSLocalizedString("Please enable the location service for Neko to detect your current WiFi network's SSID name and provide the auto-suspend services.", comment: ""))
    }
}
