...
class NetworkChangeNotifier {
    ...
    private static func startProxiesWatch() {
        ...
        if let dynamicStore = SCDynamicStoreCreate(kCFAllocatorDefault, "com.neko.proxy.networknotification" as CFString, changed, dcAddress) {
    ...
    private static func startIPChangeWatch() {
        ...
        if let dynamicStore = SCDynamicStoreCreate(kCFAllocatorDefault, "com.neko.ipv4.networknotification" as CFString, changed, dcAddress) {
    ...
    static func hasInterfaceProxySetToClash() -> Bool {
        ...
        if let prefRef = SCPreferencesCreate(nil, "Neko" as CFString, nil),
    ...
    static func getPrimaryInterface() -> String? {
        let store = SCDynamicStoreCreate(nil, "Neko" as CFString, nil, nil)
        if store == nil {
            return nil
        }
