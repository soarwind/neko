...
//            }
    ...
    static func showCreateConfigDirFailAlert(err: String) {
        let alert = NSAlert()
        alert.messageText = NSLocalizedString("Neko fail to create ~/.config/sing-box folder. Please check privileges or manually create folder and restart Neko." + err, comment: "")
